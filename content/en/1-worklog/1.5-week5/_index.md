...
- Complete the remaining Module 02 labs.
- Practice deploying servers on AWS.
- Consolidate all the knowledge learned about AWS infrastructure.
...
- Completed all of Module 02.
- Became proficient in the process of deploying EC2 within a VPC.
- Understood how AWS network components work together.
- Built a solid foundation to move into designing the Budget Tracker architecture using Serverless services such as API Gateway, Lambda, DynamoDB, Cognito, S3, Bedrock, CloudFront, and Route 53.
